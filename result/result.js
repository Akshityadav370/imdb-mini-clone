...
<div class="movie-info">
    ...
    const backPoster = document.querySelector('.movie-poster');
    // backPoster.style.background-image = URL((details.Poster != 'N/A' ? details.Poster : null));

}
// Load only clicked movie detail
async function getData(movieID) {
    const result = await fetch(`http://www.omdbapi.com/?i=${movieID}&apikey=1f05069a`); //Base URL
